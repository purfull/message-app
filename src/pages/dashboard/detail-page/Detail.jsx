...
const Detial = ({BackButton}) => {
    ...
    return ( 
     ...
     <div className="heading-2 mb-2">Upload Contact List</div>
            ...
            {/* File Upload Input */}
            <input type="file" className="border p-2 w-full" accept=".csv, .xls, .xlsx" onChange={handleFileUpload} />

            {loading && <p className="mt-4 text-blue-500">Processing file, please wait...</p>}
